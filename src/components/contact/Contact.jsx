...
const Contact = () => {
  return (
    <Wrap wrapStyles="flex h-[50vh] md:h-[60vh] items-center justify-center w-[100%] md:w-[80%] xl:w-[70%]">
      <div
        className="flex items-end shadow-md shadow-black ps-5 h-full w-[100%] relative -mr-36 md:-mr-20 lg:-mr-24 p-2 md:p-5 before:bg-[url('/images/bg3.jpg')] before:bg-cover before:bg-bottom before:mix-blend-overlay before:absolute before:content-[' '] before:top-0 before:bottom-0 before:left-0 before:right-0"
      >
