...
import man from "@/public/images/man4.png"
...
export default function Home() {
  return (
    ...
    >
      <main>
        <section
          className={`flex items-end  bg-no-repeat bg-cover bg-bottom pt-40 pb-28 md:pb-0 md:pt-12 lg:pt-24 xl:pt-32 ${classes.hero_section}`}
